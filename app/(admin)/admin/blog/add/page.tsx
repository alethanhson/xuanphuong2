    ...
    <div className="container mx-auto py-4">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Tạo một bài viết mới cho blog của bạn</p>
        </div>
            ...
            <TabsContent value="content">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Nhập thông tin nội dung cho bài viết</CardDescription>
                </CardHeader>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Nhập tiêu đề bài viết" {...field} onChange={handleTitleChange} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="nhap-tieu-de-bai-viet" {...field} />
                          </FormControl>
                          <FormDescription>URL-friendly version của tiêu đề</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="Tóm tắt ngắn gọn về bài viết" className="resize-none" {...field} />
                        </FormControl>
                        <FormDescription>Tóm tắt sẽ hiển thị ở trang danh sách bài viết</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="cnc, máy cnc, hướng dẫn" {...field} />
                        </FormControl>
                        <FormDescription>Các tags cách nhau bởi dấu phẩy</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>Bài viết sẽ được hiển thị ở trang chủ</FormDescription>
                        </div>
                        <FormControl>
            ...
            <TabsContent value="seo">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Tối ưu hóa bài viết cho công cụ tìm kiếm</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <FormField
                    control={form.control}
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Tiêu đề hiển thị trên kết quả tìm kiếm</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="Meta description cho SEO" className="resize-none" {...field} />
                        </FormControl>
                        <FormDescription>Mô tả hiển thị trên kết quả tìm kiếm</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <div className="border rounded-md p-4">
                    ...
                    <div className="space-y-1">
                      <div className="text-blue-600 text-lg">
                        {form.watch("metaTitle") || form.watch("title") || "Tiêu đề bài viết"}
                      </div>
                      <div className="text-green-700 text-sm">
                        {`${window.location.origin}/blog/${form.watch("slug") || "slug-bai-viet"}`}
                      </div>
