      ...
      <section className="py-16 bg-zinc-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-600 max-w-2xl mx-auto mt-6">
              Gặp gỡ những chuyên gia đứng sau thành công của CNC Future
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl overflow-hidden shadow-sm text-center">
              <div className="relative h-64">
                <Image src="/team-1.jpg" alt="Team member" fill className="object-cover" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-1">Nguyễn Văn A</h3>
                <p className="text-zinc-600 mb-4">Giám đốc điều hành</p>
                <p className="text-zinc-700 text-sm">
                  Hơn 15 năm kinh nghiệm trong ngành CNC, từng làm việc tại các tập đoàn lớn ở Nhật Bản và Đức.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm text-center">
              <div className="relative h-64">
                <Image src="/team-2.jpg" alt="Team member" fill className="object-cover" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-1">Trần Thị B</h3>
                <p className="text-zinc-600 mb-4">Giám đốc kỹ thuật</p>
                <p className="text-zinc-700 text-sm">
                  Tiến sĩ Cơ khí từ Đại học Bách Khoa, chuyên gia về công nghệ CNC với nhiều công trình nghiên cứu.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm text-center">
              <div className="relative h-64">
                <Image src="/team-3.jpg" alt="Team member" fill className="object-cover" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-1">Lê Văn C</h3>
                <p className="text-zinc-600 mb-4">Giám đốc kinh doanh</p>
                <p className="text-zinc-700 text-sm">
                  Hơn 10 năm kinh nghiệm trong lĩnh vực kinh doanh thiết bị công nghiệp, am hiểu thị trường Việt Nam.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-sm text-center">
              <div className="relative h-64">
                <Image src="/team-4.jpg" alt="Team member" fill className="object-cover" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-1">Phạm Thị D</h3>
                <p className="text-zinc-600 mb-4">Giám đốc dịch vụ khách hàng</p>
                <p className="text-zinc-700 text-sm">
                  Chuyên gia trong lĩnh vực chăm sóc khách hàng với phương châm "Khách hàng là trọng tâm".
                </p>
              </div>
            </div>
          </div>
